    ...
    return (
      <div class={classes.dashboardRoot}>
        <h1>Impressum</h1>
          ...
          <p>Auf dieser Website sind Plugins des Social-Media-Anbieters Facebook.com (f&#252;r Europa: Facebook Irland Limited, 4
          Grand Canal Square, Dublin 2, Ireland; f&#252;r die USA: Facebook Inc., 1601 Willow Road, Menlo Park, CA 94025, USA),
          implementiert. Eine &#220;bersicht der Facebook-Plugins finden Sie hier: <a target="_blank"
          href="https://developers.facebook.com/docs/plugins/">https://developers.facebook.com/docs/plugins/</a>.</p>
          <p>Durch Ihren Besuch auf Seiten mit Facebook-Plugins, wird durch das Plugin eine Verbindung zwischen Ihrem Browser und
          einem Server von Facebook hergestellt. Hierdurch erh&#228;lt Facebook Informationen zu Ihrer IP-Adresse und dem Besuch
          auf unserer Website.</p>
          <p>Durch Anklicken der Facebook-Plugins gelangen Sie zum Login-Bereich von Facebook. Bereits eingeloggte Facebook-Nutzer
          k&#246;nnen sofort Inhalte unserer Website auf ihren Facebook-Profilen ver&#246;ffentlichen. Infolge der Nutzung dieser
          Plugins kann Facebook den Besuch unserer Website Ihrem pers&#246;nlichen Benutzerkonto zuordnen. Wir weisen
          ausdr&#252;cklich darauf hin, dass wir als Anbieter dieser Internetseiten keine Kenntnis vom Inhalt der
          &#252;bermittelten Daten sowie deren Nutzung durch Facebook erhalten. Weitere Informationen zum Datenschutz durch
          Facebook erhalten Sie unter: <a target="_blank"
          href="https://de-de.facebook.com/policy.php">https://de-de.facebook.com/policy.php</a>.</p>
          <p>Um eine Zuordnung durch Facebook zwischen Ihrem Besuch auf unserer Website zu Ihrem Benutzerkonto zu verhindern,
          m&#252;ssen Sie sich aus Ihrem Facebook-Account ausloggen.</p>
          <p><strong>Datenschutzerkl&#228;rung Twitter</strong></p>
          <p>Auf dieser Seite sind Plugins des Messenagerdienstes Twitter (Twitter Inc., 1355 Market Street, Suite 900, San
          Francisco, CA 94103, USA) implementiert. Durch das Nutzen des Plugins werden die von Ihnen besuchten Websites mit Ihrem
          Twitter-Profil verkn&#252;pft und ver&#246;ffentlicht. Hierbei werden auch Daten an Twitter &#252;bertragen. Wir weisen
          ausdr&#252;cklich darauf hin, dass wir als Anbieter dieser Internetseiten keine Kenntnis vom Inhalt der
          &#252;bermittelten Daten sowie deren Nutzung durch Twitter erhalten. Weitere Informationen zum Datenschutz durch Twitter
          erhalten Sie unter: <a href="https://twitter.com/privacy">"https://twitter.com/privacy"</a>.</p>
          <p>Die Datenschutzeinstellungen von Twitter k&#246;nnen Sie in Ihrem Twitter-Account &#228;ndern: <a
          href="https://twitter.com/login?redirect_after_login=%2Faccount%2Fsettings">"https://twitter.com/login?redirect_after_login=%2Faccount%2Fsettings"</a></p>
          ...
          href="http://www.hensche.de/impressumsgenerator.jsp">Impressumsgenerators</a> von <a target="_blank"
          href="http://www.hensche.de/Rechtsanwalt_Arbeitsrecht_Koeln.html">HENSCHE Rechtsanw&auml;lte</a> erstellt.</p>
      </div>
    )
  }
}
